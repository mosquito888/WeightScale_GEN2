...
{
    public class WeightInHistoryService
    {
        private IConfiguration _config;
        private Uri _baseUri;
        private ApiKeyMiddleware _apiKey;

        public WeightInHistoryService(IConfiguration config)
        {
            _config = config;
        ...
        public ReturnList<ResultSearchWeightInHistoryViewModel> GetListWeightInHistory(string username)
        {
            ...
            try
            {
                ...
                var request = new RestRequest("/api/v1/WeightInHistory/GetListWeightInHistory", Method.Get);
                ...
                ReturnList<ResultSearchWeightInHistoryViewModel> respObj = JsonConvert.DeserializeObject<ReturnList<ResultSearchWeightInHistoryViewModel>>(response.Content);
                result = respObj;
                return result;
            }
            catch (Exception ex)
        ...
        public ReturnList<ResultSearchWeightInHistoryViewModel> GetSearchWeightInHistoryListData(string username, ParamSearchWeightInHistoryViewModel param)
        {
            var result = new ReturnList<ResultSearchWeightInHistoryViewModel>();
            try
            {
                ...
                options.Authenticator = new HttpBasicAuthenticator(_apiKey.BasicAuthen().username, _apiKey.BasicAuthen().password);
                var client = new RestClient(options);
                var request = new RestRequest("/api/v1/WeightInHistory/GetSearchWeightInHistoryListData", Method.Get);
