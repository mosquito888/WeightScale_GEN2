...
namespace WeightScaleGen2.BGC.Web.Services
{
    public class SystemService
    {
        ...
        public ReturnList<ResultGetSystem> GetSystem(string username)
        {
            ...
            try
            {
                ...
                var request = new RestRequest("/api/v1/System/GetSystemListData", Method.Get);
                ...
                ReturnList<ResultGetSystem> respObj = JsonConvert.DeserializeObject<ReturnList<ResultGetSystem>>(response.Content);
                result = respObj;
                return result;
            }
            catch (Exception ex)
