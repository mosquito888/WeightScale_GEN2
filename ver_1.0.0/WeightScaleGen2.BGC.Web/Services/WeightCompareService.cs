...
{
    public class WeightCompareService
    {
        private IConfiguration _config;
        private Uri _baseUri;
        private ApiKeyMiddleware _apiKey;

        public WeightCompareService(IConfiguration config)
        {
            _config = config;
        ...
        public ReturnList<ResultSearchWeightCompareViewModel> GetSearchListWeightCompare(string username, ParamSearchWeightCompareViewModel param)
        {
            ...
            try
            {
                ...
                var request = new RestRequest("/api/v1/WeightCompare/GetSearchListWeightCompare", Method.Get);
                ...
                ReturnList<ResultSearchWeightCompareViewModel> respObj = JsonConvert.DeserializeObject<ReturnList<ResultSearchWeightCompareViewModel>>(response.Content);
                result = respObj;
                return result;
            }
            catch (Exception ex)
