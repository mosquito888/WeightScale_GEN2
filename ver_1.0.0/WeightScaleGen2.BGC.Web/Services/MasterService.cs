...
namespace WeightScaleGen2.BGC.Web.Services
{
    public class MasterService
    {
        ...
        public ReturnList<ResultGetMasterViewModel> GetMasterListData(string username)
        {
        ...
        public ReturnList<ResultGetMasterTypeViewModel> GetMasterListDataType(string username)
        {
        ...
        public ReturnList<ResultSearchMasterViewModel> GetSearchMastertListData(string username, ParamSearchMasterViewModel param)
        {
            ...
            try
            {
                ...
                options.Authenticator = new HttpBasicAuthenticator(_apiKey.BasicAuthen().username, _apiKey.BasicAuthen().password);
                var client = new RestClient(options);
                var request = new RestRequest("/api/v1/Master/GetSearchMasterListData", Method.Get);
                ...
                ReturnList<ResultSearchMasterViewModel> respObj = JsonConvert.DeserializeObject<ReturnList<ResultSearchMasterViewModel>>(response.Content);
                result = respObj;
                return result;
            }
            catch (Exception ex)
        ...
        public ReturnObject<bool> Create(string username, ResultGetMasterInfoViewModel param)
        {
            ...
            try
            {
                ...
                options.Authenticator = new HttpBasicAuthenticator(_apiKey.BasicAuthen().username, _apiKey.BasicAuthen().password);
                var client = new RestClient(options);
                var request = new RestRequest("/api/v1/Master/PostItem", Method.Post);
        ...
        public ReturnObject<bool> Update(string username, ResultGetMasterInfoViewModel param)
        {
            var result = new ReturnObject<bool>();
            try
            {
                ...
                options.Authenticator = new HttpBasicAuthenticator(_apiKey.BasicAuthen().username, _apiKey.BasicAuthen().password);
                var client = new RestClient(options);
                var request = new RestRequest("/api/v1/Master/PutItem", Method.Put);
        ...
        public ReturnObject<bool> Delete(string username, ResultGetMasterInfoViewModel param)
        {
            var result = new ReturnObject<bool>();
            try
            {
                ...
                options.Authenticator = new HttpBasicAuthenticator(_apiKey.BasicAuthen().username, _apiKey.BasicAuthen().password);
                var client = new RestClient(options);
                var request = new RestRequest("/api/v1/Master/DeleteItem", Method.Delete);
