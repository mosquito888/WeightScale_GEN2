    ...
    public class WeighingScaleService
    {
        ...
        public ReturnObject<string> GetConnectWeighingScale(string username)
        {
            ...
            try
            {
                ...
                var request = new RestRequest("api/SerialPort/RunService", Method.Get);
                ...
                ReturnObject<string> respObj = JsonConvert.DeserializeObject<ReturnObject<string>>(response.Content);
                result = respObj;
                return result;
            }
            catch (Exception ex)
        ...
        public ReturnObject<decimal> GetWeightByWeighingScale(string username, string serialType)
        {
            ...
            try
            {
                ...
                options.Authenticator = new HttpBasicAuthenticator(_apiKey.BasicAuthen().username, _apiKey.BasicAuthen().password);
                var client = new RestClient(options);
                var request = new RestRequest("api/SerialPort/GetWeight?serialType=" + serialType, Method.Get);
                ...
                ReturnObject<decimal> respObj = JsonConvert.DeserializeObject<ReturnObject<decimal>>(response.Content);
                result = respObj;
                return result;
            }
            catch (Exception ex)
