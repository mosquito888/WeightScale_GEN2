...
namespace WeightScaleGen2.BGC.Web.Services
{
    public class PlantService
    {
        ...
        public ReturnList<ResultGetPlantViewModel> GetPlantListData(string username)
        {
        ...
        public ReturnList<ResultSearchPlantViewModel> GetSearchPlantListData(string username, ParamSearchPlantViewModel param)
        {
            ...
            try
            {
                ...
                options.Authenticator = new HttpBasicAuthenticator(_apiKey.BasicAuthen().username, _apiKey.BasicAuthen().password);
                var client = new RestClient(options);
                var request = new RestRequest("/api/v1/Plant/GetSearchPlantListData", Method.Get);
                ...
                ReturnList<ResultSearchPlantViewModel> respObj = JsonConvert.DeserializeObject<ReturnList<ResultSearchPlantViewModel>>(response.Content);
                result = respObj;
                return result;
            }
            catch (Exception ex)
        ...
        public ReturnObject<bool> Create(string username, ResultGetPlantInfoViewModel param)
        {
            ...
            try
            {
                ...
                options.Authenticator = new HttpBasicAuthenticator(_apiKey.BasicAuthen().username, _apiKey.BasicAuthen().password);
                var client = new RestClient(options);
                var request = new RestRequest("/api/v1/Plant/PostItem", Method.Post);
        ...
        public ReturnObject<bool> Update(string username, ResultGetPlantInfoViewModel param)
        {
            var result = new ReturnObject<bool>();
            try
            {
                ...
                options.Authenticator = new HttpBasicAuthenticator(_apiKey.BasicAuthen().username, _apiKey.BasicAuthen().password);
                var client = new RestClient(options);
                var request = new RestRequest("/api/v1/Plant/PutItem", Method.Put);
        ...
        public ReturnObject<bool> Delete(string username, ResultGetPlantInfoViewModel param)
        {
            var result = new ReturnObject<bool>();
            try
            {
                ...
                options.Authenticator = new HttpBasicAuthenticator(_apiKey.BasicAuthen().username, _apiKey.BasicAuthen().password);
                var client = new RestClient(options);
                var request = new RestRequest("/api/v1/Plant/DeleteItem", Method.Delete);
