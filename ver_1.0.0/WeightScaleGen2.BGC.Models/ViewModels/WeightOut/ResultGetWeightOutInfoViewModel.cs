...
{
    public class ResultGetWeightOutViewModel
    {
    ...
    public class ResultGetWeightOutInfoViewModel
    {
        ...
        public int reprint { get; set; }
        public string company { get; set; }
        public decimal weight_decrease { get; set; }
        public decimal weight_by_item { get; set; }
